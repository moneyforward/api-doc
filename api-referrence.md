...
|                         |リソース                                                        |必要な権限(スコープ)   |
|-------------------------|---------------------------------------------------------------|--------------------|
|金融機関のカテゴリー一覧の取得|[`GET /api/v1/service_categories`](service_categories_index.md)|`read` または `write`|
...
|                         |リソース                                                        |必要な権限(スコープ)   |
|-------------------------|---------------------------------------------------------------|--------------------|
|自動取得時のエラーの一覧の取得|[`GET /api/v1/aggregation_errors`](aggregation_errors_index.md)|`read` または `write`|
...
|                           |                                                                               |`read` または `write`|
|---------------------------|-------------------------------------------------------------------------------|--------------------|
|資産クラスごとの合計の履歴の取得|[`GET /api/v1/user_asset_class_histories`](user_asset_class_histories_index.md)|`read` または `write`|
...
|              |リソース                                            |必要な権限(スコープ)   |
|--------------|--------------------------------------------------|--------------------|
|入出金履歴の取得|[`GET /api/v1/transactions`](transactions_index.md)|`read` または `write`|

### SSOトークン

|               |リソース                                          |必要な権限(スコープ)   |
|---------------|-------------------------------------------------|--------------------|
|SSOトークンの取得|[`POST /api/v1/sso_tokens`](sso_tokens_create.md)|`read` または `write`|
