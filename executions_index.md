...
```
GET https://moneyforward.com/api/v1/executions?account_ids[]=LlPqfqeeCZavwPBLmUy6xg==&sub_account_ids[]=dyJaw7FlOG41c1C-LKndFA==&from_date=2018-01-01&to_date=2018-04-31
...
| `executions[i][execution][price]` | 価格 |
| `executions[i][execution][qty]` | 数量 |
| `executions[i][execution][cost]` | 手数料 |
